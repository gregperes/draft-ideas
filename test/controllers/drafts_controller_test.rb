...
class DraftsControllerTest < ActionController::TestCase
  ...
  test "should create draft" do
    assert_difference('Draft.count') do
      post :create, draft: { archived: @draft.archived, description: @draft.description, tags: @draft.tags, title: @draft.title, user_id: @draft.user_id }
    end
  ...
  test "should update draft" do
    patch :update, id: @draft, draft: { archived: @draft.archived, description: @draft.description, tags: @draft.tags, title: @draft.title, user_id: @draft.user_id }
    assert_redirected_to draft_path(assigns(:draft))
  end
